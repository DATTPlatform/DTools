...
MAIN_CLASS="io.nuls.network.NetworkBootstrap" # MAIN_CLASS 注入
JOPT_XMS="256"  # JOPT_XMS 注入
JOPT_XMX="512"    # JOPT_XMX 注入
JOPT_METASPACESIZE="128"  # %JOPT_METASPACESIZE 注入
JOPT_MAXMETASPACESIZE="256"  # %JOPT_MAXMETASPACESIZE 注入
JAVA_OPTS="--add-exports java.base/jdk.internal.misc=ALL-UNNAMED"  # %JAVA_OPTS 注入
